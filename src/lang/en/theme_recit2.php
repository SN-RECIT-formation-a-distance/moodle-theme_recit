...
$string['region-side-post'] = 'Center';
...
$string['enablebs4warning'] = 'Enable Bootstrap 4 class deprecated tag';
$string['enablebs4warningdesc'] = 'Enable Bootstrap 4 class deprecated tag';
...
$string['menu-m2'] = 'Vertical Left';
$string['menu-m3'] = 'Vertical Right';
$string['menu-m5'] = 'Horizontal 1 Level';
$string['show-activity-nav'] = 'Show activity navigation';
$string['show-activity-nav-help'] = "Displays 2 navigation buttons at the bottom of the page: previous activity and next activity.";
