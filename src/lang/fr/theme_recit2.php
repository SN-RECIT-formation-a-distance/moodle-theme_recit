...
$string['enablebs4warning'] = 'Activer les alertes de classes Bootstrap 4 obsolètes';
$string['enablebs4warningdesc'] = '';
...
$string['menu-m2'] = 'Vertical à gauche';
$string['menu-m3'] = 'Vertical à droite';
