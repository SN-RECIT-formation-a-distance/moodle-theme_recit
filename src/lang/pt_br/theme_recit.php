...
$string['choosereadme'] = 'Recit é um tema moderno e altamente customizável. Este tema tem por objetivo ser usado diretamente, ou como um tema pai quando criados novos temas utilizando Bootstrap 4.';
...
$string['privacy:metadata'] = 'O tema Recit theme não guarda qualquer informação pessoal de qualquer usuário.';
