...
/*//require_once($CFG->dirroot.'/mod/questionnaire/view.php');
class mod_questionnaire_view  {
public function  recitquestionnaire()
{
    ...
    echo 'et'.$questionnaire->renderer->header();
