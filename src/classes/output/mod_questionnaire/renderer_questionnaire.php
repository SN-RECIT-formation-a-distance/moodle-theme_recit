...
namespace theme_recit\output\mod_questionnaire;

defined('MOODLE_INTERNAL') || die();
class renderer_questionaire extends \mod_questionnaire\output\renderer 
/*class renderer extends \plugin_renderer_base*/ {
    ...
    public function render_viewpage($page) {
        ...
        return $this->render_from_template('theme_recit/viewpage', $data);
    }
    ...
    public function render_completepage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/completepage', $data);
    }
    ...
    public function render_reportpage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/reportpage', $data);
    }
    ...
    public function render_qsettingspage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/qsettingspage', $data);
    }
    ...
    public function render_questionspage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/questionspage', $data);
    }
    ...
    public function render_previewpage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/previewpage', $data);
    }
    ...
    public function render_nonrespondentspage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/nonrespondentspage', $data);
    }
    ...
    public function render_fbsectionspage($page) {
        $data = $page->export_for_template($this);
        return $this->render_from_template('theme_recit/fbsectionspage', $data);
    }
    ...
    public function complete_controlbuttons($inputs=null) {
        ...
        if (is_array($inputs)) {
            foreach ($inputs as $name => $attributes) {
                $output .= \html_writer::empty_tag('input', array_merge(['name' => $name,'class' => 'btn-primary'], $attributes));
            }
    ...
    public function question_output($question, $formdata, $dependants=[], $qnum, $blankquestionnaire) {
        ...
        return $this->render_from_template('theme_recit/question_container', $pagetags);
    }
    ...
    public function all_response_output($data=null) {
        ...
        if (is_string($data)) {
            ...
            foreach ($data as $qnum => $responses) {
                ...
                $output .= $this->render_from_template('theme_recit/response_container', $pagetags);
            }
        }
        return $output;
    }
    ...
    public function navigationbar($navbar) {
        return $this->render_from_template('theme_recit/navbaralpha', $navbar);
    }
    ...
    public function usernavigationbar($navbar) {
        return $this->render_from_template('theme_recit/navbaruser', $navbar);
    }
    ...
    public function responselist($navbar) {
        return $this->render_from_template('theme_recit/responselist', $navbar);
    }
